...
# - Improve get_simulation_estimates to only depend on draw_simulation_data
# - Slot in stability check in front of parameter grid
...
set.seed(1)
foo = get_error_and_averages(n_reps = 20, Tfull = 3, N = 1000, quest = 1, beta_free = 1, rho = 0.5, omega_var = 1, timer_error = T, timer_data = F, DontSkipFit = T, saveEstimates = F)
(foo)
#foo$beta_error
