...
#     req(input$plot_button)  # Only filter after button press
#     dataset() %>%
...
#            color = legend_title) +
#       theme_minimal() +
#       theme(legend.position = c(0.85, 0.85)) +  # Legend inside plot at top right
#       geom_hline(yintercept = 0, linetype = "dotted", color = "black") + # Add horizontal line at y=0
#       scale_x_continuous(breaks = seq(0, max(plot_data$N, na.rm = TRUE), by = 50))  # Set x-axis breaks at intervals of 50
#   })
# }
# 
